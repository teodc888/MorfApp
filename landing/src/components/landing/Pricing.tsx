      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mt-16">
        <RevealCard delay={0}>
          <div className="plan-card bg-surface-container-lowest p-10 rounded-xl border border-outline-variant shadow-[0_2px_16px_rgba(58,48,42,0.04)] flex flex-col">
            ...
            <a href="/contacto" className="w-full py-4 border-2 border-outline-variant text-on-surface font-bold rounded text-center hover:border-primary hover:text-primary transition-colors font-body block">
        ...
        <RevealCard delay={1}>
          <div className="coming-soon-wrap">
            <div className="plan-card bg-primary p-10 rounded-xl border border-primary-container shadow-[0_8px_32px_rgba(194,101,42,0.2)] flex flex-col relative overflow-hidden text-on-primary">
              ...
              <a href="/contacto" className="w-full py-4 bg-surface-bright text-primary font-bold rounded hover:bg-surface-container-low transition-colors shadow-sm font-body text-center block">
                Elegir Pro
              </a>
            </div>
