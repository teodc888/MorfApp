...
namespace MorfApp.Infrastructure.Migrations
{
    ...
    [Migration("20260728201114_AddTenantMarketingFields")]
    partial class AddTenantMarketingFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MorfApp.Domain.Entities.ErrorLog", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_error_logs_tenant_id");

                    b.HasIndex("IsResolved", "CreatedAt")
                        .HasDatabaseName("ix_error_logs_is_resolved_created_at");
            ...
            modelBuilder.Entity("MorfApp.Domain.Entities.SubscriptionCharge", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_subscription_charges");

                    b.HasIndex("MpPaymentId")
                        .IsUnique()
                        .HasDatabaseName("ix_subscription_charges_mp_payment_id");

                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_subscription_charges_tenant_id");

                    b.ToTable("subscription_charges", (string)null);
                });
            ...
            modelBuilder.Entity("MorfApp.Domain.Entities.Tenant", b =>
                {
                    ...
                    b.HasIndex("MpPreapprovalId")
                        .IsUnique()
                        .HasDatabaseName("ix_tenants_mp_preapproval_id");
            ...
            modelBuilder.Entity("MorfApp.Domain.Entities.ErrorLog", b =>
                {
                    b.HasOne("MorfApp.Domain.Entities.Tenant", "Tenant")
                        ...
                        .HasConstraintName("fk_error_logs_tenants_tenant_id");
            ...
            modelBuilder.Entity("MorfApp.Domain.Entities.SubscriptionCharge", b =>
                {
                    b.HasOne("MorfApp.Domain.Entities.Tenant", "Tenant")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_subscription_charges_tenants_tenant_id");
